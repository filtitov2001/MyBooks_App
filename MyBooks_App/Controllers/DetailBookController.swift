...
struct DetailBookProvider: PreviewProvider {
    ...
    struct ContainerView: UIViewControllerRepresentable {
        ...
        let viewController = DetailBookController()
        
        func makeUIViewController(context: UIViewControllerRepresentableContext<DetailBookProvider.ContainerView>) -> DetailBookController {
